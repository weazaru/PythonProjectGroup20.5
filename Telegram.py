...
bot = telebot.TeleBot('6244920773:AAGjUPIAyjFtF8OWdrV0izgRE9_J4RlMfCk')
...
def get_text_messages(message):
    ...
    if message.text == '👋 Привет':
        ...
        btn1 = types.KeyboardButton('Как стать автором на Хабре? Я не могу определиться')
        btn2 = types.KeyboardButton('Правила сайта 21')
        markup.add(btn1, btn2)
        bot.send_message(message.from_user.id, '❓ Задайте интересующий вас вопрос', reply_markup=markup) #ответ бота


    elif message.text == 'Как стать автором на Хабре? Я не могу определиться':
    ...
    elif message.text == 'Правила сайта 21':
